                   ...
                   <span class="buy-user">艾迪 </span>
					...
					<div class="logistics">
						...
						<ul class="op_express_delivery_hot">
							<li data-value="yuantong" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -468px"></i>自己取书<span></span></li>
							<li data-value="shentong" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -1008px"></i>对方送书<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="../images/wangyin.jpg" />华农绿色书币<span></span></li>
							<li class="pay qq"><img src="../images/weizhifu.jpg" />其他支付方式<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
