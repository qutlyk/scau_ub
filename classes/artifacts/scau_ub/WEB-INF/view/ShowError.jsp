...
.error-page-main:before{content:'';display:block;background:url(images/errorPageBorder.png?1427783409637);height:7px;position:absolute;top:-7px;width:100%;left:0}
        ...
        <div class="error-page-main">
            ...
            <div class="error-page-actions">
                ...
                <div>
                    <h4>可以尝试：</h4>
                    <ul>
                        <li><a href="http://119.29.236.54/">返回首页</a></li>
                    </ul>
                </div>
            </div>
        </div>
