...
<script src="JSP/AmazeUI-2.4.2/assets/js/amazeui.js"
	type="text/javascript"></script>
			...
			<div class="search-bar pr">
				...
				<form action="search.jsp">
					<input type="hidden" value="<%=user.getUserid()%>" id="userid"
						...
						name="index_none_header_sysc" type="text" placeholder="书名/出版社"
				...
				<div class="user-info">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf">
							<strong class="am-text-danger am-text-lg">个人信息</strong> / <small>Personal&nbsp;information</small>
						</div>
					</div>
					<hr />
					...
					<div class="user-infoPic">
						...
						<div class="info-m">
							<div>
								<b>用户名：<i><%=user.getUsername()%></i></b>
							</div>
							<div class="u-level">
								<span class="rank r2"> <s class="vip1"></s><font
									class="classes" color="#0000FF" >易班网薪: <%=user.getMoney()%></font>
								</span>
							</div>
						</div>
					</div>
							...
							<div class="am-form-group">
								...
								<div class="am-form-content">
									<input type="text" id="user-name2"
										value="<%=user.getUsername()%>" placeholder="name">
...
<input type="hidden" value="<%=user.getUserid()%>" id="user-id">
							<div class="am-form-group">
