...
<%
		...
		//String items = request.getParameterValues("items[]");//itemids
		String itemid= request.getParameter("itemid");
			...
			List<Item> order_items = new ArrayList<Item>();
				...
				Item a=CheckData.getitem(Integer.parseInt(itemid));
		...
		//}
			...
			int num_items=order_items.size();
				...
				<div class="paycont">
					...
					<div class="logistics">
						...
						<ul class="op_express_delivery_hot">
							<li class="pay taobao" onclick="typeOfTransmit(this.id)"><img src="./JSP/images/facetoface.jpg" />当面交易<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay taobao" onclick="judge2()"><img src="./JSP/images/moneysmall.jpg" />易班网薪<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
					...
					<div class="concent">
						<div id="payTable">
							...
							<div class="clear"></div>
							<form action="successPay.jsp<%=hrefuser %>" method="post" id="form_payOrders">
<%
			for(int i = 0;i<num_items;i++){
				Item item = new Item();
				item = order_items.get(i);
...
%>
								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													...
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11"><%=item.getBookname() %></a>
														</div>
													</div>
												</li>
												<li class="td td-info">
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now"><%=item.getPrice() %></em>
														</div>
													</div>
												</li>
											</div>
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number"><%=item.getPrice() %></em>
												</div>
											</li>
							...
							<div class="clear"></div>
							<input type="text" name="itemid"  hidden="hidden"  value="<%=item.getItemid() %>">
<%} %>
							<input type="text" name="sum"  hidden="hidden"  value="<%=sum %>">
							</form>
							<div class="clear"></div>
							<div class="pay-total">
						<!--留言-->
