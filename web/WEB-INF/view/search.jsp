...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	String useridstr= request.getParameter("userid");
		...
		Long userid = Long.valueOf(hrefuser);
	    user.setUserid(userid);
	    user.setUsername("叶镇亮");

	//String searchInput=new String(request.getParameter("index_none_header_sysc").getBytes("ISO-8859-1"),"utf-8");
	//String searchInput = request.getParameter("index_none_header_sysc");
	//searchInput = URLDecoder.decode(searchInput,"gbk");
	//List<Item> searchItemList=CheckData.getsearchItem(searchInput);
	...
	<body >
		<%--<%if(user.getAdress()==""||user.getAdress()==null||user.getPhonenumber()==""||user.getPhonenumber()==null) {%>--%>
		<%--<input type ="hidden"  id="tip" value="refuseShopping"/>--%>
		<%--<%} %>--%>
		<!--顶部导航条 -->
			...
			<div class="nav white">
				...
				<div class="search-bar pr">
					...
					<form action="search.jsp">
				         <input type="hidden" value="<%=hrefuser%>" id="userid" name="userid">
					     <input value=${keyword} id="searchInput" name="index_none_header_sysc" type="text"placeholder="书名/出版社" autocomplete="on">
	                  	...
	                  	<div class="theme-popover">														
							...
							<ul class="select">
								<p class="title font-normal">
									...
									<span class="total fl">搜索到<strong class="num">${booklist.size()} </strong>件相关商品</span>
								</p>
								<div class="clear"></div>
							...
							<div class="search-content">
								<div class="sort">
									...
									<li><a title="按价格排序" href= "book/pricesort?userid=<%=hrefuser %>&keyword=${keyword}" >按价格排序</a></li>
								</div>
								<div class="clear"></div>
								...
								<c:forEach items="${booklist}" var="it" >
									<li>
										...
										<a href="book/introduction?userid=<%=hrefuser%>&itemid=${it.getItemid()}" class="J_MakePoint">
